...
* [How to use Sol/Maia Software on your linux workstation](https://webapps.lehigh.edu/dokuwiki/sites/researchcomputing/doku.php?id=linux)
* [LTS provides licensed and open source virtualized software for Windows, Mac
  and Linux](https://software.lehigh.edu) and [Gogs](https://gogs.cc.lehigh.edu), a self hosted Git Service
or Github clone 
