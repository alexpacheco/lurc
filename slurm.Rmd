...
* There are three distinct file spaces on Sol.
   ...
   * __CEPHFS__, 11TB global parallel scratch for running jobs with a lifetime of 14 days.
- Best Practices
...
|:---------:|:--------------------:|:----------------------------:|
| lts | 6.4 | 6.2 |
| eng/im1080/enge/engi/im2080/chem/health | 5.3 | 5.1 |
| engc | 2.66 | 2.4 |
| himem | 32 | 31.5 |
...
# YMMV
# scontrol -s hostname > hostfile
# mpiexec -n ${SLURM_NTASKS} -f hostfile ./myjob < filename.in > filename.out
...
![:scale 85%](assets/img/slurmreport.png) 
