...
<span class="tiny">_Python modules_</span>
...
* provides a portfolio of national high-performance computing facilities housing some of the world’s most advanced supercomputers.
* Innovative and Novel Computational Impact on Theory and Experiment ([INCITE](https://proposals.doeleadershipcomputing.org)) program open to researchers from academia, government labs, and industry
   - proposals are accepted between mid-April and the end of June 
   - Argonne Leadership Computing Facility - 27-petaflop Cray XK7, "Titan" 
   - Oak Ridge Leadership Computing Facility - 10-petaflop IBM Blue Gene/Q, "Mira".
   - Over 6B SUs allocated for CY 2018
   - Average requests were 75M for Titan and 100M SUs for Mira
