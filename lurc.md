...
* Total SU on Sol after Condo Investments: 14,226,240
...
* Stanford University
   - XStream: 1 PFlops, 65 nodes with 8 NVIDIA Tesla K80 each
...
* EWFM 292 on Thursday from 2:10PM - 4:00PM.
  - Using SLURM scheduler on Sol (Sep 20)
  - Document Creation with LaTeX (Sep 27)
  - Version Control with GIT (Oct 4)
  - Python Programming (Oct 11)
  - Data Visualization in Python (Oct 18)
