...
* <strong> Sol </strong>
  - Lehigh's Flagship High Performance Computing Cluster
     * Expected to be production ready by October 1, 2016
...
* Condo Investors (Faculty who have increased Sol's capacity by purchasing 26 nodes).
   ...
   - Condo Investor 1 purchased 1 20-core node is provided with 175,200 SUs annually.
   - Condo Investor 2 purchase 25 24-core nodes is provided with 5,256,000 SUs annually.
...
#SBATCH --time=1:00:00 SBATCH --nodes=1 --ntasks-per-node=24
#SBATCH --job-name myjob
...
<tr>
  <td><code>checkjob jobid</code></td><td>Check status of your job identified by <em>jobid</em></td><td><code></code></td>
</tr>
<tr>
