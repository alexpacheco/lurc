...
# ![:scale 30%](https://raw.githubusercontent.com/OSC/Open-OnDemand/gh-pages/assets/images/ood_logo_stack_rgb.png)
...
* A singularity image of CENTOS 7 with MATE and XFCE desktop environment is used to provide a VDI.
   - Dockerfile and Singularity definition files:   https://github.com/alexpacheco/lurc-ood-desktop
   - Docker Images: https://hub.docker.com/r/alexpacheco/centos7
...
* Launch Jupyter Notebooks with any Anaconda/Python 3.x module.

* You can also own conda environment provided you have jupyter notebooks installed in your environment

* By default,
   - 1 node per job
   - Only non gpu partitions enabled
...
* Available versions
   - 3.5.3 and 3.6.3
   - 4.0.2 with three different sets of package themes
...
* [ANSYS Workbench](https://confluence.cc.lehigh.edu/x/yaX0BQ)
...
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ-syHgWJDCC0ETFlAX1BmX9Ib8roiX55SjAF3xMhNmGEZEfGxnyEPLEEMqN7TfbDj2fzVjcXW8m5U1/pubhtml?widget=true&amp;headers=false" width="960" height="480"></iframe>
